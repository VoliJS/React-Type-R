...
var link_1 = require("valuelink/lib/link");
exports.default = link_1.Link;
type_r_1.Mixable.mixins.populate(link_1.Link);
/**
 * Record
 */
type_r_1.MixinsState.get(type_r_1.Record).merge([{
...
var CollectionLinkMixin = {
    ...
    linkAt: function (prop) {
        var _this = this;
        return link_1.Link.value(this[prop], function (x) { return _this[prop] = x; });
    }
};
type_r_1.MixinsState.get(type_r_1.Record.Collection).merge([CollectionLinkMixin]);
/**
